...
public class XYLineChartReport {
    ...
    /**
     * <p>Constructor for XYLineChartReport.</p>
     */
    ...
    private JRDataSource createDataSource() {
        ...
        IntStream.range(0, 20).forEachOrdered(i -> dataSource.add(i, (int) (Math.random() * 10), (int) (Math.random() * 10)));
        return dataSource;
    }
}
